...
import AgentTryOn from "./pages/AgentTryOn";
import AgentStyleDNA from "./pages/AgentStyleDNA";
        ...
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Routes>
              ...
              <Route path="/agent/tryon" element={<AgentTryOn />} />
              <Route path="/agent/style-dna" element={<AgentStyleDNA />} />
