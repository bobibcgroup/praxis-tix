...
import { getSession, setBodyProfile } from '../../../src/lib/biometricSessionStore';
import { runBodyPipeline } from '../../../src/lib/bodyPipelineService';

/** POST /api/biometrics/session/body — Upload full-body image. Body: session_id, image (base64). */
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.error('[biometrics/session/body]', err);
